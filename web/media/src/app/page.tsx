...
export default function Page() {
  return (
    <div className="fixed inset-0 bg-black text-white flex flex-col px-4 space-y-16 md:px-8 md:max-w-7xl md:mx-auto md:space-y-0">
      <header>
      ...
      <div className="flex-1 flex flex-col md:justify-center space-y-4 z-10 md:max-w-lg md:mx-auto">
